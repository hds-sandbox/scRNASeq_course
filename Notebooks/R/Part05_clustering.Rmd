...
sample.combined.sct <- LoadH5Seurat("/work/Intro_to_scRNAseq_R/Results/sample_23.filt.norm.red.h5Seurat")
```
...
```{r}
write.table(x = all.markers, file = "/work/Intro_to_scRNAseq_R/Results/all_markers.tsv", col.names = TRUE, row.names = FALSE, sep = "\t", quote = FALSE)
```
...
```{r}
SaveH5Seurat(sample.combined.sct, filename = "/work/Intro_to_scRNAseq_R/Results/sample_23.filt.norm.red.clust.h5Seurat")
```
