...
LoadH5Seurat("/work/Intro_to_scRNAseq_R/Results/sample_2.filt.h5Seurat")
```
...
SaveH5Seurat(sample_2, filename = "/work/Intro_to_scRNAseq_R/Results/sample_2.filt.norm.h5Seurat")
```
...
```{r}
sample_2 <- LoadH5Seurat("/work/Intro_to_scRNAseq_R/Results/sample_2.filt.h5Seurat")
```
...
Normalize and perform dimensionality reduction on sample 3. This is necessary for the next part of the workshop: integration of datasets.
