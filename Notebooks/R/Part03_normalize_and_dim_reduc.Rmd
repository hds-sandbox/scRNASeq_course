...
LoadH5Seurat("/work/Intro_to_scRNAseq_R/data/notebooks_data/sample_2.filt.h5Seurat")
```
...
SaveH5Seurat(sample_2, filename = "/work/Intro_to_scRNAseq_R/data/notebooks_data/sample_2.filt.norm.h5Seurat")
```
