...
LoadH5Seurat("/work/Intro_to_scRNAseq_R/data/notebooks_data/sample_2.filt.norm.h5Seurat")
LoadH5Seurat("/work/Intro_to_scRNAseq_R/data/notebooks_data/sample_3.filt.norm.h5Seurat")
```
...
```{r}
SaveH5Seurat(sample.combined.sct, filename = "/work/Intro_to_scRNAseq_R/data/notebooks_data/sample_123.filt.norm.red.h5Seurat")
```
