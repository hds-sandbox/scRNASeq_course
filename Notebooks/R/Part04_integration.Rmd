...
sample_2 <- LoadH5Seurat("/work/Intro_to_scRNAseq_R/Results/sample_2.filt.norm.h5Seurat")
sample_3 <- LoadH5Seurat("/work/Intro_to_scRNAseq_R/Results/sample_3.filt.norm.h5Seurat")
```
...
```{r}
SaveH5Seurat(sample.combined.sct, filename = "/work/Intro_to_scRNAseq_R/Results/sample_23.filt.norm.red.h5Seurat")
```
