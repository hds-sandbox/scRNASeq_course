...
```{r}
SaveH5Seurat(sample_2, filename = "/work/Intro_to_scRNAseq_R/Results/sample_2.filt.h5Seurat")
```
...
Filter sample 3 using the tools and knowledge you obtained from this lesson! It will be necessary for the last parts of the workshop.
