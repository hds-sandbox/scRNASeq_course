...
```{r}
SaveH5Seurat(sample_2, filename = "/work/Intro_to_scRNAseq_R/Results/sample_2.h5Seurat")
```
...
```{r}
#Convert("/work/Intro_to_scRNAseq_R/Results/sample_2.h5Seurat", dest = "h5ad")
Convert("/work/Intro_to_scRNAseq_R/Results/sample_2.h5ad", dest = "h5Seurat", overwrite = TRUE)
```

To load a H5Seurat object, use the following function `LoadH5Seurat()`:

```{r}
sample_2 <- LoadH5Seurat("/work/Intro_to_scRNAseq_R/Results/sample_2.h5seurat")
```
